        ...
        <div>
            ...
            <ProjectN1Box>
                ...
                <div>
                    ...
                    <a href={'https://github.com/Carvalho001/Data-Collector'} rel={'noreferrer'} target={'_blank'}><button>Ver no Github</button></a>
                </div>
            </ProjectN1Box>
            <ProjectN2Box>
                <div>
                    ...
                    <a href={'https://github.com/Carvalho001/Labeddit'} rel={'noreferrer'} target={'_blank'}><button>Ver no Github</button></a>
                </div>
            ...
            <ProjectN3Box>
                ...
                <div>
                    ...
                    <a href={'https://github.com/Carvalho001/Olympics-API'} rel={'noreferrer'} target={'_blank'}><button>Ver no Github</button></a>
                </div>
            </ProjectN3Box>
            <ButtonBox>
